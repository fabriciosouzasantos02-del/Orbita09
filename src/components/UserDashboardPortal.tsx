...
const localPortalTranslations: Record<string, Record<string, string>> = {
  ...
  "es": {
    ...
    "Harmonização Avançada & Alinhamento Domiciliar": "Armonización Avanzada & Alineación Domiciliaria",
    "Cristal de Ancoragem": "Cristal de Anclaje",
    "Ritual do Espaço": "Ritual del Espacio",
    "Direção Auspiciosa": "Dirección Auspiciosa",
    "Frequência de Som": "Frecuencia de Sonido",
    "Caminho": "Camino",

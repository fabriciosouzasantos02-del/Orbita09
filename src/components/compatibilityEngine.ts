...
export function computeDetailedCompatibility(
  ...
  const t: Record<string, any> = {
    pt: {
      ...
      porQueExisteCompatibilidade: `A compatibilidade profunda de vocês baseia-se na complementariedade das forças essenciais. ${name1} possui energia natal vibrante que alimenta e inspira os planos de ${name2}, que por sua vez estimula o desenvolvimento pessoal de ${name1}. A vibração dos elementos das duas tabelas astrológicas mostra uma bela harmonia de cooperação mútua.`,
      ...
      lidarDinheiro: `Com a harmonia dos Mapas Astrais de ambos, ${name1} tende a planejar o orçamento focando em metas de segurança de longo prazo com excelente pragmatismo, enquanto ${name2} preza pela liberdade de adquirir bens refinados que trazem felicidade imediata. O casal resolve essa equação criando uma conta de objetivos conjuntos e respeitando as verbas de lazer individuais.`,
      lidarCiumes: `O ciúmes é processado de forma interna por ambos. ${name1} pode acumular sentimentos e manifestar um afastamento terno e breve, enquanto ${name2} sente a necessidade de recolhimento para avaliar as causas lógicas. A comunicação direta e madura evita o bloqueio da intimidade de forma instantânea.`,
      resolverConflitos: `Vocês resolvem atritos de forma muito superior ao estabelecerem acordos baseados no bom senso. O canal de comunicação flui bem com o dinamismo de ambos, permitindo que o casal discuta assuntos difíceis sorrindo descontraídos, sem adotar atitudes defensivas de dominação ou deboche.`,
      ...
      quemTendeDominar: `${name1} domina suavemente as iniciativas sociais, escolhas de destinos de viagens e convívios devido à sua energia vibracional natal. No âmbito doméstico e fiduciário de longo prazo, de forma invisível porém eficiente, ${name2} impõe limites sólidos e dita o ritmo das decisões importantes da casa.`,
      convivencia: `A convivência diária resplandece pelo aconchego terno promovido pela sintonia benéfica dos dois mapas astrais. A harmonia nas discussões rotineiras assegura que a moradia seja um santuário de paz verdadeira e inspiração de alma para o desenvolvimento de suas vocações.`,
      ...
      aprendizadosMutuos: `O aprendizado mútuo é a expansão da tolerância espiritual. ${name1} aprende a desacelerar seu ímpeto dinâmico natal com a tranquila segurança prática de ${name2}, enquanto ${name2} descobre com ${name1} a coragem sagrada de abraçar novas mudanças e horizontes grandiosos.`,

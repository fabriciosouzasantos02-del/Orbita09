...
export const TRANSLATIONS_WORLD: Record<string, Record<string, Partial<TarotCard>>> = {
  en: {
    ...
    judgement: { name: "Judgement", arcana: "Major", uprightMeaning: "Absolution, cosmic calling, spiritual awakening, sound inner evaluation.", reversedMeaning: "Self-doubt, harsh self-judgment, fear of answering the higher call.", description: "The angel blowing the golden trumpet, awakening souls to their true spiritual path." },
    world: { name: "The World", arcana: "Major", uprightMeaning: "Completion, cosmic integration, global accomplishment, supreme harmony.", reversedMeaning: "Incomplete cycles, delayed fulfillment, lingering attachments.", description: "A figure dancing inside a green laurel wreath, surrounded by the four sacred corner symbols." }
  },
  es: {
    ...
    emperor: { name: "El Emperador", arcana: "Mayor", uprightMeaning: "Estructura, autoridad justa, estabilidad mundana, liderazgo.", reversedMeaning: "Rigidez excessive, tiranía, desorganización o falta de control.", description: "Sentado en un trono de piedra tallada con cabezas de carnero." },
    ...
    tower: { name: "La Torre", arcana: "Mayor", uprightMeaning: "Ruptura repentina, verdad revelada de forma abrupta, choque liberador.", reversedMeaning: "Evitar el desmoronamento necessário, temor al colapso inevitable.", description: "Una torre de piedra siendo alcanzada por un rayo azul ardiente." },
    ...
    judgement: { name: "El Juicio", arcana: "Mayor", uprightMeaning: "Absolución, llamada cósmica, despertar espiritual, evaluación sana.", reversedMeaning: "Autoduda, juicio duro sobre uno mismo, temor a responder a la llamada superior." },
    world: { name: "El Mundo", arcana: "Mayor", uprightMeaning: "Realización completa, integración cósmica, éxito global, armonía suprema.", reversedMeaning: "Ciclos incompletos, cumplimiento retrasado, apegos pendientes." }
  },
  de: {
    ...
    hierophant: { name: "Der Hohepriester", arcana: "Große", uprightMeaning: "Mystische Tradition, anerkannte spirituelle Weisheit.", reversedMeaning: "Dogmatismus, mystische Rebellion." },
    ...
    judgement: { name: "Gericht", arcana: "Große", uprightMeaning: "Absolution, kosmischer Ruf, spirituelles Erwachen.", reversedMeaning: "Selbstzweifel, strenge Selbstbeurteilung." },
    world: { name: "Die Welt", arcana: "Große", uprightMeaning: "Vollendung, kosmische Integration, globaler Erfolg.", reversedMeaning: "Unvollständige Zyklen, verzögerte Erfüllung." }
  },
  fr: {
    ...
    hierophant: { name: "Le Pape", arcana: "Majeur", uprightMeaning: "Tradition mystique, sagesse spirituelle reconnue.", reversedMeaning: "Dogmatisme, rébellion mystique." },
    ...
    judgement: { name: "Le Jugement", arcana: "Majeur", uprightMeaning: "Absolution, appel cosmique, éveil spirituel.", reversedMeaning: "Doute de soi, jugement sévère envers soi-même." },
    world: { name: "Le Monde", arcana: "Majeur", uprightMeaning: "Accomplissement, intégration cosmique, succès global.", reversedMeaning: "Cycles incomplets, réalisation retardée." }
  }
};
